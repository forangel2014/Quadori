...
class BartForConditionalGeneration_WeightedGroupBeam(BartForConditionalGeneration):
    ...
    def group_beam_search(
        ...
        input_ids: torch.LongTensor,
        beam_scorer: BeamScorer,
        #weights: Optional[torch.Tensor] = None, #[batch_size]
        logits_processor: Optional[LogitsProcessorList] = None,
        max_length: Optional[int] = None,
        pad_token_id: Optional[int] = None,
        eos_token_id: Optional[int] = None,
        ...
        **model_kwargs,
        ...
        #weights = model_kwargs['weights']
        weights = output_scores
        output_scores = True
        ...
        while cur_len < max_length:
            ...
            for beam_group_idx in range(num_beam_groups):
                ...
                # add weight
                #next_token_logits = weights.view(-1,1) * next_token_logits
